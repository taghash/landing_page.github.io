...
const Banner = () => {
  return (
    <div className='p-10 md:p-10 pt-0 md:pt-10 flex bg-neutral-100 flex-col md:flex-row md:justify-around'>
        <motion.div className='mt-12' variants={containerVariants} initial='hidden' animate='visible' exit='exit'>
        ...
        <motion.div className='z-1 w-2/3 mt-5 ml-10 md:w-1/4' variants={containerVariants} initial='hidden' animate='visible' exit='exit'>

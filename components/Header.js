        ...
        <div className="flex justify-between items-center border-gray-100 py-3 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a onClick={()=>router.push('/')}>
              ...
              <Image src={logo} width={100} h={20} className='cursor-pointer' />
            </a>
          </div>
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            ...
            <a onClick={()=> router.push('/about')} className="cursor-pointer text-base font-medium text-gray-500 hover:text-gray-900">
              About Us
            </a>
            <Popover className="relative">
              {({ open }) => (
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a
              href="#"
              className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2  rounded-md  text-base font-medium text-white hover:scale-105 hover:transition-all" style={{background: 'linear-gradient(90deg, hsl(231deg 89% 51%) 0%, hsl(210deg 100% 61%) 100%)'}}
            >
              Contact Sales
            </a>
